...
int main()
{
  ...
  //  flaszki.push_back(LesserHpPotek);
    ...
    //HP,speed,dmg,dodge
    Enemy chimera("$%!#&",200,2,40,10);
    Enemy dzik("Dzik",140,5,25,20);
    Enemy czlowiek("Klusownik",110,3,15,45);
    Enemy waz("Waz",80,4,30,30);
    Enemy krokodyl("Krokodyl",110,2,30,30);
    ...
    nazwa Miasto10("POWINIENEM SIE PRZYGOTOWAC DO WYPRAWY","MIASTO10","1)Udaj sie do kowala ","2)MIASTO2","Udaj sie do alchemiczki ","MIASTO3","3)Udaj sie do platnerza ","MIASTO4");
    ...
    nazwa Koniec1("Po paru dniach podrozy w koncu docierasz do kresu swojej przygody.Oddajesz notaki starcowi.Gdy je przeglda az blyszcza mu sie oczy.Dostajesz swoja zaplate.Za taka sume mozesz zyc jak krol przez nastepne pare miesiecy.","KONIEC1");
    nazwa Koniec2("Rozpalasz ogien.Czy napewno chce je zniszczyc?","KONIEC2","1)TAK","KONIEC3","2)NIE","KONIEC1");
    nazwa Koniec3("Wrzucasz notatki do ognia.Po chwili nie ma juz po nich nawet sladu.Nie udalo ci sie wykonac misji ale przynajmniej masz czyste sumienie.A to jest bezcenne.Prawda?","KONIEC3");
